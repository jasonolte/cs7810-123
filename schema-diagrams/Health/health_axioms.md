...
For all x implies either there does not exist a y and a relationship hasSeverity with x and y or there exists exactly 1 y and a relationship hasSeverity with x and y.
...
For all x implies either there does not exist a y and a relationship affects with x and y or there exists exactly 1 y and a relationship affects with x and y.
...
For all x implies either there does not exist a y and a relationship hasHealth with x and y or there exists exactly 1 y and a relationship hasHealth with x and y.
